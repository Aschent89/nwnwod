void main()
{
    ...
    string sTag2 = "Binding5";
    string sTag3 = "Int_binding_5";
    string sMessage1 = "Binding 5 is set.";
    ...
    effect eBlue = EffectVisualEffect(VFX_DUR_GLOW_LIGHT_YELLOW);
    effect eWarding = EffectVisualEffect(VFX_DUR_GLYPH_OF_WARDING);
    effect eWord = EffectVisualEffect(VFX_FNF_LOS_EVIL_30);
    effect eVis5 = EffectVisualEffect(VFX_IMP_PULSE_FIRE);
