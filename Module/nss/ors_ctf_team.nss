...
void main()
{
  ...
  if(sSign == "CTFBlueTeam")
  {
    CTF_SetPCBlueTeam(oPC);

    object oBlue = GetObjectByTag("WP_CTFBLUESIDE_HOME");
  ...
  if(sSign == "CTFRedTeam")
  {
    CTF_SetPCRedTeam(oPC);

    object oRed = GetObjectByTag("WP_CTFREDSIDE_HOME");
