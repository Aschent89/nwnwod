...
//Plays correct animation for gun.
void animateReload(object oTarget);
...
void animateReload(object oTarget)
{
    ...
    if (iBaseType == BASE_ITEM_SHORTBOW)
    {
     AssignCommand(oTarget,PlaySound("firearm_reload1"));
     AssignCommand(oTarget,ActionPlayAnimation(36,0.5, 2.0));
    }
    else if (iBaseType == BASE_ITEM_HEAVYCROSSBOW || iBaseType == BASE_ITEM_SLING)
    {
     AssignCommand(oTarget,PlaySound("firearm_reload1"));
     AssignCommand(oTarget,ActionPlayAnimation(37,0.5, 2.0));
    }
    else if (iBaseType == BASE_ITEM_LONGBOW || iBaseType == BASE_ITEM_LIGHTCROSSBOW)
    {
     AssignCommand(oTarget,PlaySound("firearm_reload1"));
     AssignCommand(oTarget,ActionPlayAnimation(35,0.5, 2.0));
    }
}
//void main(){}
