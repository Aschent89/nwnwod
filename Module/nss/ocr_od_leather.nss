////////////////////////////////////////////////////////////////////////////////
//
//  Olander's Realistic Systems - Leather Working Table
//  ocr_od_leather
//  By:Don Anderson
//  dandersonru@msn.com
//
//  This is placed in the OnDamaged Event of the Crafting Leather Working Table
//
////////////////////////////////////////////////////////////////////////////////
...
void main()
{
    ...
    string sItem = GetLocalString(oPC,"OCR_LEATHER");

    string sTool = "Please equip the Skinning Knife to work at the Leather Table.";
    string sSuccess = "Well done and nice work!";
    string sFail = "Keep cutting. It is coming along nicely!";
