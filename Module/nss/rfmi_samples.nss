...
RewardForMultipleItems(GetPCSpeaker(), OBJECT_SELF, "Tag", 15, 10, 25, PARTY_RESTRICT_SAME_AREA, TRUE, FALSE, 0, TRUE, FALSE, FALSE);
...
RP_XP(200, GetPCSpeaker(), PARTY_RESTRICT_ALL_MEMBERS);
...
//does it take items.
RP_GP(300, GetPCSpeaker(), PARTY_RESTRICT_NO_PARTY);
...
GetVar_INT(GetPCSpeaker(), OBJECT_SELF, "Tag");
