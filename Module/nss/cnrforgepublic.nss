...
void main()
{
  ...
  sKeyToRecipe = CnrRecipeCreateRecipe("cnrForgePublic", "Umbral Silver Ingot(s)", "ingotumbralsilv", 1);
  CnrRecipeAddComponent(sKeyToRecipe, "umbralsilvchunk", 3, 1);
  CnrRecipeSetRecipeLevel(sKeyToRecipe, 12);
  CnrRecipeSetRecipeXP(sKeyToRecipe, 150, 150);
  CnrRecipeSetRecipeAbilityPercentages(sKeyToRecipe, 25, 75, 0, 0, 0, 0);

  sKeyToRecipe = CnrRecipeCreateRecipe("cnrForgePublic", "Umbral Gold Ingot(s)", "ingotumbralgold", 1);
  CnrRecipeAddComponent(sKeyToRecipe, "umbralsilvgold", 3, 1);
  CnrRecipeSetRecipeLevel(sKeyToRecipe, 12);
  CnrRecipeSetRecipeXP(sKeyToRecipe, 150, 150);
  CnrRecipeSetRecipeAbilityPercentages(sKeyToRecipe, 25, 75, 0, 0, 0, 0);
}
