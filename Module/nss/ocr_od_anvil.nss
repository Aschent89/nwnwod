////////////////////////////////////////////////////////////////////////////////
//
//  Olander's Realistic Systems - Anvil
//  ocr_od_anvil
//  By:Don Anderson
//  dandersonru@msn.com
//
//  This is placed in the OnDamaged Event of the Crafting Anvil
//
////////////////////////////////////////////////////////////////////////////////
...
void main()
{
    ...
    string sItem = GetLocalString(oPC,"OCR_ANVIL");

    string sTool = "Please equip the Smithing Hammer to work at the Anvil.";
    string sSuccess = "Well done and nice work!";
    string sFail = "Keep hammering. It is coming along nicely!";
