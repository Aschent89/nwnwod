...
int CNR_TRADESKILL_FOOD_INFUSING = 101;
...
// ore mining
float CNR_FLOAT_ORE_MINING_FIND_SECOND_NUGGET_PERCENTAGE = 50.0;
float CNR_FLOAT_ORE_MINING_FIND_MYSTERY_MINERAL_PERCENTAGE = 35.0;
...
float CNR_FLOAT_FORGE_COAL_BURN_TIME = 360.0f; // 1 min per nugget

// gem mining
float CNR_FLOAT_GEM_MINING_FIND_FIRST_MINERAL_PERCENTAGE = 50.0;
float CNR_FLOAT_GEM_MINING_FIND_SECOND_MINERAL_PERCENTAGE = 35.0;
...
// misc tool breakage
float CNR_FLOAT_SMITH_HAMMER_BREAKAGE_PERCENTAGE = 0.1;
float CNR_FLOAT_GEM_CRAFTERS_TOOLS_BREAKAGE_PERCENTAGE = 0.1;
float CNR_FLOAT_TINKERS_TOOLS_BREAKAGE_PERCENTAGE = 0.1;
float CNR_FLOAT_CARPS_TOOLS_BREAKAGE_PERCENTAGE = 0.1;
float CNR_FLOAT_SEWING_KIT_BREAKAGE_PERCENTAGE = 0.1;

// plant/fruit respawns
float CNR_FLOAT_DEFAULT_PLANT_RESPAWN_TIME_SECS = 900.0; // 5 mins real time
