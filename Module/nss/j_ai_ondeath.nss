...
/*
 * Modifed by CatScan to include HCR 3.2b onDeath functionality
 */

// HCR: Include hc_ondeath_i
...
void main()
{
   ...
   // This executes the pwfxp script to yield xp for players.
...
************************* [Alternative Corpses] *******************************/
    ...
    // HCR: Added NPC Misc corpse stuff
