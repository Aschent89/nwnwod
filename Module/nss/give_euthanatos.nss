...
object oTarget;
oTarget = GetItemPossessedBy(oPC, "mage_pouch");

CreateItemOnObject("mage_euthanatos", oTarget);

CreateItemOnObject("mage_entr_1", oTarget);

CreateItemOnObject("magepoint", oTarget);
CreateItemOnObject("magepoint", oTarget);
