...
void main()
{
    ...
    string sSpeak = "The enchanted collar around the neck of " + sSlaveName + " stops glowing, allowing them to use furniture.";

    //Flag them as being able to use furniture
    DeleteLocalInt(oSlave, "COLLAR_NO_SIT");
