void main()
{
    ...
    string sTag3 = "Int_binding_1";
    string sMessage1 = "Binding 1 is set.";
    ...
    effect eVis5 = EffectVisualEffect(VFX_FNF_PWSTUN);
...
if(GetItemPossessedBy(oPC, "Rune_Stone") == OBJECT_INVALID)
  ...
  return;
    ...
    DelayCommand(4.3, ApplyEffectAtLocation(nDuration1, eVis7, lPC, 3.0));
