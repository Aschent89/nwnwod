void main()
{
    ...
    string sTag3 = "Int_binding_2";
    string sMessage1 = "Binding 2 is set.";
    ...
    effect eBlue = EffectVisualEffect(VFX_DUR_GLOW_LIGHT_RED);
    effect eWarding = EffectVisualEffect(VFX_DUR_GLYPH_OF_WARDING);
    effect eWord = EffectVisualEffect(VFX_FNF_ELECTRIC_EXPLOSION);
    effect eVis5 = EffectVisualEffect(VFX_FNF_DECK);
