...
string LORD_SZGYAMBIENT_00 = "I wont make that stupid mistake again!";
string LORD_SZGYAMBIENT_01 = "Why must I toss my life away so easly?";
string LORD_SZGYAMBIENT_02 = "Thank the god's! There is a secound chance for me.";
string LORD_SZGYAMBIENT_03 = "I need to be more carefull next time";
string LORD_SZGYAMBIENT_04 = "I want to live! I want to live!";
string LORD_SZGYAMBIENT_05 = "This is the last time I'll be running this circle.";


// Ambient Comments ... <%area%> and <%playername%> are valid variables
string LORD_SZGYAMBIENTC_00 = "I have to be more careful!";
string LORD_SZGYAMBIENTC_01 = "How long must I run this circle?";
string LORD_SZGYAMBIENTC_02 = "I should find a new line of work when i get out of here!";
string LORD_SZGYAMBIENTC_03 = "This isnt worth it ... I better be careful!";
string LORD_SZGYAMBIENTC_04 = "Why me!";
string LORD_SZGYAMBIENTC_05 = "So this is what the after life is like. How boaring";
...
void main()
{
    ...
    else if (sTag == "lordo_gmemo")
    {
        ...
        AssignCommand(oUser,ActionPlayAnimation(ANIMATION_LOOPING_MEDITATE,1.0,600.0));
