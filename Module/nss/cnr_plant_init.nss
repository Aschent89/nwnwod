...
void main()
{
  ...
  CnrPlantInitialize("cnrPileOfDirt", "cnrGraveyardDirt", 2, CNR_FLOAT_DEFAULT_PLANT_RESPAWN_TIME_SECS);
  CnrPlantInitialize("cnrPileOfSalt", "cnrSalt", 3, CNR_FLOAT_DEFAULT_PLANT_RESPAWN_TIME_SECS);
  CnrPlantInitialize("cnrSacksOfSalt", "cnrSalt", 5, CNR_FLOAT_DEFAULT_PLANT_RESPAWN_TIME_SECS);
  CnrPlantInitialize("cnrSacksOfSugar", "cnrSugar", 5, CNR_FLOAT_DEFAULT_PLANT_RESPAWN_TIME_SECS);
  CnrPlantInitialize("cnrMaplePlant", "cnrMapleSyrup", 2, CNR_FLOAT_DEFAULT_PLANT_RESPAWN_TIME_SECS);
  // endless supplies
  /*
