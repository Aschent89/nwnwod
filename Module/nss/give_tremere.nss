...
CreateItemOnObject("vamp_tremere", oPC);
CreateItemOnObject("vamp_g_dom_1", oPC);
CreateItemOnObject("vamp_g_ausp_1", oPC);
CreateItemOnObject("vamp_thaumaturgy", oPC);
//CreateItemOnObject("vamppoint", oPC);
//CreateItemOnObject("vamppoint", oPC);
CreateItemOnObject("gblood", oPC);
CreateItemOnObject("gblood", oPC);
CreateItemOnObject("gblood", oPC);
CreateItemOnObject("gblood", oPC);
//CreateItemOnObject("ks_key_camerilla", oPC);
