...
void main()
{
  ...
  int nNPrice = GetLocalInt(oNPC,"BUY_NORMPRICE" + IntToString(7));
  int nBPrice = GetLocalInt(oNPC,"BUY_BULKPRICE" + IntToString(7));

  //PC is Selling these
  string sTag = GetLocalString(oNPC,"TAG" + sNPC + IntToString(7));
