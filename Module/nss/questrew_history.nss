...
RewardForMultipleItems(GetPCSpeaker(), OBJECT_SELF, "ks_pageofhistory", 150, 100, 3, PARTY_RESTRICT_SAME_AREA, TRUE, FALSE, 0, TRUE, FALSE, FALSE);
...
GetVar_INT(GetPCSpeaker(), OBJECT_SELF, "ks_pageofhistory");
