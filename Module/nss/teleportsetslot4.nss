void main()
{
    ...
    string sTag2 = "Binding4";
    string sTag3 = "Int_binding_4";
    string sMessage1 = "Binding 4 is set.";
    ...
    effect eBlue = EffectVisualEffect(VFX_DUR_GLOW_LIGHT_PURPLE);
    effect eWarding = EffectVisualEffect(VFX_DUR_GLYPH_OF_WARDING);
    effect eWord = EffectVisualEffect(VFX_FNF_HOWL_MIND);
    effect eVis5 = EffectVisualEffect(VFX_IMP_DEATH_WARD);
