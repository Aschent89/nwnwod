/*
 * Set CUSTOM tokens for the printing of the PC values
 *
...
int StartingConditional()
{
    ...
    int iLastHour = GetLocalInt( oTarget, cMvD_02_sHourLastGiven );
    int iLastMin = GetLocalInt( oTarget, cMvD_02_sMinLastGiven );
    ...
    if( iSperre ) {
        SetCustomToken( 5002, "gesperrt" );
    } else {
        SetCustomToken( 5002, "nicht gesperrt" );
    }
    return( TRUE );
}
