...
const int ARMOR_IS_BREAKABLE = FALSE;
const int ARROWS_ARE_BREAKABLE = TRUE;
const int BASTARDSWORDS_ARE_BREAKABLE = FALSE;
const int BATTLEAXES_ARE_BREAKABLE = FALSE;
const int BELTS_ARE_BREAKABLE = FALSE;
const int BOLTS_ARE_BREAKABLE = TRUE;
const int BOOKS_ARE_BREAKABLE = TRUE;
const int BOOTS_ARE_BREAKABLE = FALSE;
const int BRACERS_ARE_BREAKABLE = FALSE;
const int BULLETS_ARE_BREAKABLE = TRUE;
const int CLOAKS_ARE_BREAKABLE = TRUE;
const int CLUBS_ARE_BREAKABLE = FALSE;
const int DAGGERS_ARE_BREAKABLE = FALSE;
const int DARTS_ARE_BREAKABLE = TRUE;
const int DIREMACES_ARE_BREAKABLE = FALSE;
const int DOUBLEAXES_ARE_BREAKABLE = FALSE;
const int GEMS_ARE_BREAKABLE = FALSE;
const int GLOVES_ARE_BREAKABLE = TRUE;
const int GOLD_IS_BREAKABLE = FALSE;
const int GREATAXES_ARE_BREAKABLE = FALSE;
const int GREATSWORDS_ARE_BREAKABLE = FALSE;
const int GRENADES_ARE_BREAKABLE = TRUE;
const int HALBERDS_ARE_BREAKABLE = FALSE;
const int HANDAXES_ARE_BREAKABLE = FALSE;
const int HEALERSKITS_ARE_BREAKABLE = TRUE;
const int HEAVYCROSSBOWS_ARE_BREAKABLE = TRUE;
const int HEAVYFLAILS_ARE_BREAKABLE = FALSE;
const int HELMETS_ARE_BREAKABLE = FALSE;
const int JEWELS_ARE_BREAKABLE = FALSE;
const int KAMAS_ARE_BREAKABLE = FALSE;
const int KATANAS_ARE_BREAKABLE = FALSE;
const int KEYS_ARE_BREAKABLE = FALSE;
const int KUKRI_ARE_BREAKABLE = FALSE;
const int LARGEBOXES_ARE_BREAKABLE = TRUE;
const int LARGESHIELDS_ARE_BREAKABLE = FALSE;
const int LIGHTCROSSBOWS_ARE_BREAKABLE = TRUE;
const int LIGHTFLAILS_ARE_BREAKABLE = FALSE;
const int LIGHTHAMMERS_ARE_BREAKABLE = FALSE;
const int LIGHTMACES_ARE_BREAKABLE = FALSE;
const int LONGBOWS_ARE_BREAKABLE = TRUE;
const int LONGSWORDS_ARE_BREAKABLE = FALSE;
const int MAGICRODS_ARE_BREAKABLE = TRUE;
const int MAGICSTAFFS_ARE_BREAKABLE = TRUE;
const int MAGICWANDS_ARE_BREAKABLE = TRUE;
const int MORNINGSTARS_ARE_BREAKABLE = FALSE;
const int POTIONS_ARE_BREAKABLE = TRUE;
const int QUARTERSTAFFS_ARE_BREAKABLE = TRUE;
const int RAPIERS_ARE_BREAKABLE = FALSE;
const int RINGS_ARE_BREAKABLE = FALSE;
const int SCIMITARS_ARE_BREAKABLE = FALSE;
const int SCROLLS_ARE_BREAKABLE = TRUE;
const int SCYTHES_ARE_BREAKABLE = FALSE;
const int SHORTBOWS_ARE_BREAKABLE = TRUE;
const int SHORTSPEARS_ARE_BREAKABLE = TRUE;
const int SHORTSWORDS_ARE_BREAKABLE = FALSE;
const int SHURIKEN_ARE_BREAKABLE = FALSE;
const int SICKLES_ARE_BREAKABLE = FALSE;
const int SLINGS_ARE_BREAKABLE = TRUE;
const int SMALLSHIELDS_ARE_BREAKABLE = FALSE;
const int THIEVESTOOLS_ARE_BREAKABLE = TRUE;
const int THROWINGAXES_ARE_BREAKABLE = FALSE;
const int TORCHES_ARE_BREAKABLE = TRUE;
const int TOWERSHIELDS_ARE_BREAKABLE = FALSE;
const int TRAPKITS_ARE_BREAKABLE = TRUE;
const int TWOBLADEDSWORDS_ARE_BREAKABLE = FALSE;
const int WARHAMMERS_ARE_BREAKABLE = FALSE;
...
const int MAX_CHANCE_OF_DMG = 90; // The cap for the likelihood of broken objects (max: 100)
const int DAMAGE_INCREMENT = 15; // Each time a container is damaged, the chance of broken items is increased by this percentage.
