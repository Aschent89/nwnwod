...
void main()
{
    ...
    int nAppearance = BDSM_NUMBER_STRAP_ON_F;
    ...
    //Removal messages
    string sSpeak1 = sOwnerName + " removes a strap on dildo from the waist of " + sTargetName;
    string sOwnerMessage1 = "You remove the strap on dildo from the waist of " + sTargetName;
    string sTargetMessage1 = sOwnerName + " removes the strap on dildo from your waist.";

    //Add messages " + sTargetName;
    string sSpeak2 = sOwnerName + " secures a strap on dildo around the waist of " + sTargetName;
    string sOwnerMessage2 = "You secure a strap on dildo around the waist of " + sTargetName;
    string sTargetMessage2 = sOwnerName + " secures a strap on dildo around your waist.";
