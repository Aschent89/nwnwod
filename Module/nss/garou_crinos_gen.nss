...
if (GetItemPossessedBy(oPC,"change_fang")!= OBJECT_INVALID)
{
DelayCommand(3.0, SetCreatureAppearanceType(oPC, 1530));
...
if (GetItemPossessedBy(oPC,"change_fen")!= OBJECT_INVALID)
{
...
if (GetItemPossessedBy(oPC,"change_fia")!= OBJECT_INVALID)
{
...
////////////////////////////////////
////// Children of Gaia CHANGES /////////////
///////////////////////////////////

if (GetItemPossessedBy(oPC,"change_gaia")!= OBJECT_INVALID)
{
DelayCommand(3.0, SetCreatureAppearanceType(oPC, 3201));
