...
//Vampire Transformation Options
  ...
  //on purpose or by accident.
    const int UseSubRaceField = FALSE;
  ...
  //the vampire sucking the blood of their friend
    const int CheckForVampireSeen = FALSE;
...
//Vampire Bite Options
  ...
  //This is what level a pc can begin making vampires at
    const int SpreadVampirismLevel = 5;
...
//                          boosted stats based upon your epic vampire level
  const int UseImprovedThrall = FALSE; //setting this to false will disable all epic
                                      //thralls...
...
//                        thrall.
  const int UseUnholyThrall = FALSE; //Setting this to false will also disable the
                                    //upgraded unholy thrall...
  const int UseUnholyThrallLevel2 = FALSE;
...
//                                ancient bat.
  const int UseChildrenOfTheNight = FALSE; //setting this to false will disable the
...
//                            randomly summon Vengence, Hate or Pain
  const int UseKinOfTheDamned = FALSE; //setting this to false will disable twin
...
//                            Shadow Dragon, an Undead Slime, or a Hand of Evil.
  const int UseTwinOfTheAbyss = FALSE;
...
//                            You may take this again to double the regen.
  const int UseBloodOfTheLand = FALSE; //setting this to false will also disable
                                      //the level 2 blood of the land.
  const int UseBloodOfTheLandLevel2 = FALSE;
...
//                       energy.
  const int UseHolyVampire = FALSE;
...
//                         this ability a second time to double the uses per day.
  const int UseLookOfHunger = FALSE;
  const int UseLookOfHungerLevel2 = FALSE;
...
//                 for whomever was bothering you.
  const int UseRefuge = FALSE;
//        Unturnable - You can never be turned by turn undead.
  const int UseTurnProof = FALSE;
