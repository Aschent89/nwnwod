...
RewardForMultipleItems(GetPCSpeaker(), OBJECT_SELF, "x2_it_cmat_leath", 25, 10, 25, PARTY_RESTRICT_SAME_AREA, TRUE, FALSE, 0, TRUE, FALSE, FALSE);
...
GetVar_INT(GetPCSpeaker(), OBJECT_SELF, "x2_it_cmat_leath");
